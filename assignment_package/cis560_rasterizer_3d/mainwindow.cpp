...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    ...
    case Qt::Key_W: rasterizer.moveCamera(glm::vec4(0,0,0.2,0)); break;
    case Qt::Key_S: rasterizer.moveCamera(glm::vec4(0,0,-0.2,0)); break;
    case Qt::Key_D: rasterizer.moveCamera(glm::vec4(0.5,0,0,0)); break;
    case Qt::Key_A: rasterizer.moveCamera(glm::vec4(-0.5,0,0,0)); break;
    case Qt::Key_Q: rasterizer.moveCamera(glm::vec4(0,-0.5,0,0)); break;
    case Qt::Key_E: rasterizer.moveCamera(glm::vec4(0,0.5,0,0)); break;
    case Qt::Key_Up: rasterizer.addRotation(glm::vec4(1,0,0,1),-5); break;
    case Qt::Key_Down: rasterizer.addRotation(glm::vec4(1,0,0,1),5); break;
    case Qt::Key_Left: rasterizer.addRotation(glm::vec4(0,1,0,1),5); break;
    case Qt::Key_Right: rasterizer.addRotation(glm::vec4(0,1,0,1),-5); break;
    case Qt::Key_Z: rasterizer.addRotation(glm::vec4(0,0,1,1),5); break;
    case Qt::Key_X: rasterizer.addRotation(glm::vec4(0,0,1,1),-5); break;
    }
...
//            this,
//            // Slot name
//            SLOT(on_changeMode_currentIndexChanged(int)));

//    connect(ui->changeLight,
//            // Signal name
//            SIGNAL(currentIndexChanged(int)),
//            // Widget with the slot that receives the signal
//            this,
//            // Slot name
//            SLOT(on_changeLight_currentIndexChanged(int)));
}
...
{
    rasterizer.setAntiAliasing(index+1);
    //Rasterizer::AntiAliasing = index+1;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}


void MainWindow::on_changeMode_currentIndexChanged(int index)
{
    Rasterizer::LineMode = index;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}


void MainWindow::on_changeLight_currentIndexChanged(int index)
{
    rasterizer.lMode = (lightMode)index;
    rendered_image = rasterizer.RenderScene();
    DisplayQImage(rendered_image);
}


void MainWindow::on_changeMSAA_currentIndexChanged(int index)
{
    rasterizer.setAntiAliasing(index+1);
    //Rasterizer::AntiAliasing = index+1;
    rendered_image = rasterizer.RenderScene();
