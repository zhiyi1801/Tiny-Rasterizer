...
public:
    ...
    LineSegment2D(const glm::vec3& p1, const glm::vec3& p2);
    LineSegment2D(const glm::vec4& p1, const glm::vec4& p2);
    LineSegment2D();
...
glm::vec3 GetBarycentric(const Vertex &v1, const Vertex &v2, const Vertex &v3, const glm::vec4 &p);
